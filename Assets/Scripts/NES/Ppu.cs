...
namespace Nes
{
    public class Ppu
    {
        ...
        private const int OamSize = 64 * BytesPerSprite;
        ...
        public void Step()
        {
            ...
            if (CurrentScanline < VisibleScanlines)
            {
                ...
                // Sprite Rendering
                {
                    ...
                    if (CurrentScanline >= 0 && CurrentCycle >= 1 && CurrentCycle <= 64)
                    {
                        ...
                        {
                            _secondaryOam[CurrentCycle / 2] = OamData;
                        }
            ...
            if (ShouldRenderBackground())
            {
                ...
                byte paletteLSB = (byte)((_backgroundShifterAttributeLo & mux) > 0 ? 1 : 0);
                byte paletteMSB = (byte)((_backgroundShifterAttributeHi & mux) > 0 ? 1 : 0);
        ...
        private void LoadBackgroundShifters()
        {
            ...
            _backgroundShifterAttributeLo = (byte)(_backgroundLatchAttributeLo ? 0xFF : 0x00);
            _backgroundShifterAttributeHi = (byte)(_backgroundLatchAttributeHi ? 0xFF : 0x00);
        ...
        public byte ReadRegister(ushort address)
        {
            ...
            {
                _ioBus = (byte)((byte)_ppuStatus & 0xE0);
                SetStatusFlag(Status.VBlank, false);
                _w = false;
            }
        ...
        private ushort GetNametableAddress(ushort address)
        {
            ...
            Mapper.MirrorMode mode = _emulator.Mapper.Mode;
